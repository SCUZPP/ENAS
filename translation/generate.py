...
def main(args):
    ...
    print('scorer.score()',scorer.score())
    return scorer.score()


def model_test(args, encoder_seq, encoder_para, decoder_seq, decoder_para):
    ...
    if paras > 40000000:
        print('paras > 40000000')
        return 0 '''
    
    length = len(encoder_seq)+ len(decoder_seq)
    ...
    args.source_lang = 'de'
    args.target_lang = 'en' 
    args.path = 'log/iwslt_de_en/man_iwslt_de_en_v/checkpoint_best.pt'
    t = main(args)
    return t
